 ...
 *
 * Based on original implementation: http://code.google.com/p/processing/source/browse/trunk/processing/android/examples/Sensors/Compass/CompassManager.java?r=7743.
 * Just commented out the stuff i'm not using (compass events) 
 * & changed back the direction to degrees instead of radians.
 *
 */
      ...
      */
      ...
      if (directionEventMethod != null) {
        try {
          ...
          directionEventMethod.invoke(context, new Object[] { (float) x }); // degrees instead of radians.
        } catch (Exception e) {
          e.printStackTrace();
